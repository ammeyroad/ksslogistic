  ...
  <section>
    ...
    <di class=" ">
      <div class=" p-5 mx-auto">
        <div
          class="grid max-w-screen-lg mx-auto  overflow-hidden sm:grid-cols-2  -mt-36 relative shadow-lg rounded-xl bg-white lg:grid-cols-3 items-center ">

          <!-- Icon Block -->
          <div class="hover:bg-blue-600 hover:text-white py-20 p-10">
            <svg class="flex-shrink-0 size-9 " xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <div class="mt-5">
              ...
              <p class="mt-1 ">Components are easily customized and extendable</p>
            </div>
          </div>
          <!-- End Icon Block -->
          <!-- Icon Block -->
      ...
      <div class="grid lg:grid-cols-7 sm:gap-24 lg:items-center">
        <div class="pb-0 sm:mb-0 lg:col-span-4">
          ...
          <div class="mt-5 max-w-xl">
            <p class="text-lg text-gray-600 dark:text-gray-400">{Deskripsi satu Preline is a large open-source project,
              crafted with
