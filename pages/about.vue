<template>
  <div class="">
      ...
      <div class="relative overflow-hidden">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div class="max-w-2xl text-center mx-auto">
            <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-5xl">Designed for you to get more
          ...
          <div class="mt-10 relative max-w-5xl mx-auto">
            ...
            <div class="absolute inset-0 size-full">
              <div class="flex flex-col justify-center items-center size-full">
                <a class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-full border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
                  href="#">
            ...
            <div class="grid sm:grid-cols-2 gap-12 py-12">
              <div class="lg:w-3/4">
              ...
              <div class="grid">
                <a class="group flex gap-y-6 size-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075] dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  ...
                  <div>
                    <div>
                      <h3 class="block font-bold text-gray-800 dark:text-white">Visi</h3>
                ...
                <a class="group flex gap-y-6 size-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075] dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  ...
                  <div>
                    <div>
                      <h3 class="block font-bold text-gray-800 dark:text-white">Build misi</h3>
                      <p class="text-gray-600 dark:text-gray-400">The simplest way to keep your portfolio always
                        up-to-date.</p>
                    </div>
              ...
              <nav class="grid gap-4 mt-5 md:mt-10" aria-label="Tabs" role="tablist">
                <button type="button"
                  ...
                  <span class="flex">
                    ...
                    <span class="grow ms-6">
                      <span class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800">Advanced
                        tools</span>
                      <span class="block mt-1 text-gray-800">Use Preline thoroughly thought and automated libraries to
                ...
                <button type="button"
                  ...
                  <span class="flex">
                    ...
                    <span class="grow ms-6">
                      <span class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800">Smart
                        dashboards</span>
                      <span class="block mt-1 text-gray-800">Quickly Preline sample components, copy-paste codes, and
                ...
                <button type="button"
                  ...
                  <span class="flex">
                    ...
                    <span class="grow ms-6">
                      <span class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800">Powerful
                        features</span>
                      <span class="block mt-1 text-gray-800">Reduce time and effort on building modern look design with
                        Preline only.</span>
                    </span>
                  </span>
                </button>
    ...
    <section id="about" class="bg-blue-700 overflow-hidden min-h-max flex items-center relative"
      data-v-inspector="pages/services.vue:31:3">
      <div
        ...
        data-v-inspector="pages/services.vue:32:5"></div>
      <div
        ...
        data-v-inspector="pages/services.vue:35:5"></div>
      <div class="px-4 py-16 mb-60 sm:mb-32 mx-auto sm:max-w-xl lg:max-w-screen-xl sm:px-0 lg:py-32"
        data-v-inspector="pages/services.vue:38:5">
        <div class="grid max-w-screen-lg gap-8 lg:grid-cols-12 sm:mx-auto" data-v-inspector="pages/services.vue:39:7">
          <div class="flex flex-col justify-center lg:col-span-8" data-v-inspector="pages/services.vue:40:9">
            <h3
              ...
              data-v-inspector="pages/services.vue:41:11">About Us</h3><!-- Features -->
            <div class="" data-v-inspector="pages/services.vue:46:11">
              <div class="flex flex-col sm:mb-0" data-v-inspector="pages/services.vue:47:13">
                <div class="max-w-xl mb-8 md:mx-autolg:max-w-2xl md:mb-12" data-v-inspector="pages/services.vue:48:15">
                  <div id="judul" data-v-inspector="pages/services.vue:49:17">
                    <h1 class="mb-2 text-3xl font-bold leading-none tracking-tight text-blue-00 sm:text-4xl md:mx-auto"
                      data-v-inspector="pages/services.vue:50:19"><span
                        class="bg-blue-50 inline-block border border-dashed border-blue-600 m-1 p-2"
                        data-v-inspector="pages/services.vue:51:21">Karya Sarana Samudra</span> informasi lengkap </h1>
                    <p class="font-medium mt-4" data-v-inspector="pages/services.vue:54:19">Kami berkomitmen untuk
                      menyediakan layanan berkualitas tinggi dan inovatif kepada pelanggan kami.</p>
                  </div>
                        ...
                        <div class="flex">
                          ...
                          <div class="pt-1 pb-8">
                            ...
                            <p class="text-gray-700">
                              All recipes are written using certain conventions, which define the characteristics of
                        ...
                        <div class="flex">
                          ...
                          <div class="pt-1 pb-8">
                            ...
                            <p class="text-gray-700">
                              ...
                              in their tropic island nest. Michael Knight a young loner.
                            </p>
                          </div>
                        </div>
                        <div class="flex">
          ...
          <div class="lg:col-span-4" data-v-inspector="pages/services.vue:90:9">
            <div class="grid grid-cols-2" data-v-inspector="pages/services.vue:91:11"><img
                class="object-cover w-full h-96 col-span-2" src="/kss-3.png" alt=""
                data-v-inspector="pages/services.vue:92:13"><img
                class="object-cover w-full h-48 border-b-8 border-blue-600" src="/kss-1.png" alt=""
                data-v-inspector="pages/services.vue:93:13"><img
                class="object-cover w-full h-48 border-b-8 border-blue-600" src="/kss-2.png" alt=""
                data-v-inspector="pages/services.vue:94:13"></div>
          </div>
        </div>
      </div>
    </section>
    <section>
      <!-- Hero -->
      <div class="max-w-screen-lg mx-auto mt-24 px-6 sm:px-0">
        <!-- Grid -->
        <div class="grid lg:grid-cols-7 sm:gap-24 lg:items-center">
          <div class="pb-0 sm:mb-0 lg:col-span-4">
            <div class="flex justify-left">
              <a class="inline-flex items-center gap-x-2 bg-yellow-400 border border-yellow-200 text-xs text-gray-600 font-bold p-2 px-3 rounded-full transition hover:border-gray-300 "
                href="#">
                {badge satu}
            ...
            <!-- Title -->
            <div class="mt-5 ">
              <h1 class="block font-bold text-blue-600 text-3xl md:text-4xl  ">
                {Heading satu Experience}
              </h1>
            </div>
            <!-- End Title -->
            <div class="mt-5 max-w-xl">
              <p class="text-lg text-gray-600 dark:text-gray-400">{Deskripsi satu Preline is a large open-source
                project,
                crafted with
            ...
            <div class="grid  gap-2  mt-4 ">
              <a class="group flex flex-col hover:bg-white hover:border hover:shadow-sm rounded-xl hover:shadow-md transition "
                href="#">
                <div class="p-4 md:p-5">
                  <div class="flex">
                    ...
                    <div class="grow ms-5">
                      <h3 class="group-hover:text-blue-600 mb-2 font-semibold text-gray-800 ">
                        {Subjudul Ask our community}
                      </h3>
                      <p class="text-sm text-gray-500">
                        {Subdeskripsi Get help from 40k+ Preline users et help from 40k+ Preline users}
                      </p>
                    </div>
                  </div>
                </div>
...
<div class="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5">
  <div class="flex flex-col  space-y-16">
    ...
    <section class="bg-slate-100 mt-24">
      <!-- Hero -->
      <div class="max-w-screen-xl mx-auto text-center pt-24 sm:px-0">
        <!-- Grid -->
        <div class="grid lg:grid-cols-7 sm:gap-24 lg:items-center">
          <div class="pb-0 sm:mb-0 lg:col-span-7">
            <div class="flex justify-left">
              <a class="mx-auto inline-flex items-center gap-x-2 bg-yellow-400 border border-yellow-200 text-xs text-gray-600 font-bold p-2 px-3 rounded-full transition hover:border-gray-300 "
                href="#">
                {badge satu}
            ...
            <!-- End Title -->
            <div class="mt-5">
              <p class="text-lg  max-w-xl mx-auto text-gray-600 dark:text-gray-400">{Deskripsi satu Preline is a large
                open-source project,
                crafted with
                Tailwind CSS .}</p>
            </div>
            ...
            <div class="max-w-screen-2xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
              <div class="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-2">
                <!-- Icon Block -->
                <a class="bg-[url('https://images.unsplash.com/photo-1606868306217-dbf5046868d2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3481&q=80')] bg-cover bg-center group border overflow-hidden border-white text-left rounded-x flex flex-col justify-end hover:bg-gray-50 hover:shadow-lg rounded-xl h-[370px]   "
                  href="#">
                  <div
                    class="group-hover:opacity-100 group-hover:py-10 bg-gradient-to-t from-black via-black/50 to-transparent duration-100 opacity-50  p-4 md:p-7">
                    <h3 class="group-hover:text-white text-lg font-semibold text-gray-800 pr-4 ">
                      Marine Logistics Transportation</h3>
    ...
    <section class="bg-blue-700 pt-60 pb-40 -mt-60">
      <!-- Hero -->
      <div class="max-w-screen-xl mx-auto  sm:px-0">
        <!-- Features -->
        <div class="max-w-screen-xl sm:px-16 mx-auto">
          <div class="relative md:p-16">
            <!-- Grid -->
            <div class="relative px-8 sm:px-0 z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
              <div class="mb-10 lg:mb-0 lg:col-span-6 lg:order-2">
                <div class="pb-0 sm:mb-0 lg:col-span-7">
                  ...
                  <div class="mt-5 text-white">
                    <h1 class="block font-bold text-2xl md:text-4xl  ">
                      {Heading satu Experience}
                    </h1>
                  </div>
                  <!-- End Title -->
                  <div class="mt-5">
                    <p class="text-lg  max-w-xl text-white">{Deskripsi satu Preline is a large
                      open-source project,
                      crafted with
                      Tailwind CSS .}</p>
                  </div>
                ...
                <!-- Tab Navs -->
                <nav class="grid mt-5 md:mt-4" aria-label="Tabs" role="tablist">
                  <button type="button"
                    class="hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-start hover:bg-gray-50 p-4 md:p-5 rounded-xl  active"
                    id="tabs-with-card-item-1" data-hs-tab="#tabs-with-card-1" aria-controls="tabs-with-card-1"
                    role="tab">
                    <span class="flex group">
                      <svg
                        class="flex-shrink-0 mt-2 size-6 md:size-7 hs-tab-active:text-blue-600 text-slate-100 group-hover:text-blue-600"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M5 5.5A3.5 3.5 0 0 1 8.5 2H12v7H8.5A3.5 3.5 0 0 1 5 5.5z" />
                        <path d="M12 2h3.5a3.5 3.5 0 1 1 0 7H12V2z" />
                      ...
                      <span class="grow ms-6 text-slate-200 hover:text-blue-600">
                        <span
                          class="block text-lg font-semibold hs-tab-active:text-blue-600  dark:hs-tab-active:text-blue-500 ">Advanced
                          tools</span>
                        <span class="block mt-1 group-hover:text-slate-700">Use
                          Preline thoroughly thought and automated libraries .</span>
                      </span>
                    </span>
                  </button>

                  <button type="button"
                    class="hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-start hover:bg-gray-50 p-4 md:p-5 rounded-xl "
                    id="tabs-with-card-item-2" data-hs-tab="#tabs-with-card-2" aria-controls="tabs-with-card-2"
                    role="tab">
                    <span class="flex">
                      <svg
              ...
              <div class="lg:col-span-6">
                <div class="relative">
                  ...
                  <div>
                    <div id="tabs-with-card-1" role="tabpanel" aria-labelledby="tabs-with-card-item-1">
                      <img class="shadow-xl rounded-xl dark:shadow-gray-900/[.2]"
                        src="https://images.unsplash.com/photo-1605629921711-2f6b00c6bbf4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&h=1220&q=80"
                        alt="Image Description">
                    </div>
            ...
            <div class="absolute inset-0 grid grid-cols-12 size-full">
              <div
                class="col-span-full lg:col-span-7 lg:col-start-6 bg-transparent w-full h-5/6 rounded-xl sm:h-3/4 lg:h-full">
              </div>
            </div>
            <!-- End Background Color -->
          </div>
    ...
    <section class="px-8 ">
      <div
        class="max-w-screen-lg rounded-xl p-8 bg-blue-600 shadow-lg border-t-2 -mt-28  py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <!-- Grid -->
        <div class="grid items-center lg:grid-cols-12 gap-6 lg:gap-12">
          <div class="lg:col-span-4 ">
            <!-- Stats -->
            <div class="lg:pe-6 xl:pe-12">
              <p class="text-4xl font-bold leading-10 text-white">
                92%

              </p>
              <p class="mt-2 sm:mt-3 text-slate-200">of U.S. adults have bought from businesses using Space</p>
            </div>
            <!-- End Stats -->
          </div>
          <!-- End Col -->
          ...
          <div
            class="lg:col-span-8 relative lg:before:absolute lg:before:top-0 lg:before:-start-12 lg:before:w-px lg:before:h-full lg:before:bg-gray-200 lg:before:dark:bg-gray-700">
            <div class="grid gap-10 grid-cols-2 md:grid-cols-4 lg:grid-cols-4 sm:gap-8">
              <!-- Stats -->
              <div>
                <p class="text-3xl font-semibold text-white">99.95%</p>
                <p class="mt-1 text-slate-200">in fulfilling orders</p>
              </div>
              <!-- End Stats -->

              <!-- Stats -->
              <div>
                <p class="text-3xl font-semibold text-white">2,000+</p>
                <p class="mt-1 text-slate-200">partner with Preline</p>
              </div>
              <!-- End Stats -->
              ...
              <div>
                ...
                <p class="mt-1 text-slate-200">this year alone</p>
              </div>
              <!-- End Stats -->
              <div>
                <p class="text-3xl font-semibold text-white">85%</p>
    ...
    <section class="mt-16 px-8">
      <!-- Hero -->
      <div class="max-w-screen-lg mx-auto text-left pt-24 sm:px-0">
        <!-- Grid -->
        <div class="grid lg:grid-cols-7 sm:gap-24 lg:items-center">
          <div class="pb-0 sm:mb-0 lg:col-span-7">
            <div class="flex justify-left">
            ...
            <div class="flex-row sm:flex items-end">
              <div class="mt-5 sm:w-1/2 pr-4">
                <h1 class="block font-bold text-blue-600 text-3xl md:text-4xl  ">
                  {Heading satu Experience}
                </h1>
              </div>
              <!-- End Title -->
              <div class="mt-5">
                <p class="text-lg  text-gray-600 dark:text-gray-400">{Deskripsi satu Preline is a large
                  open-source project, crafted with Tailwind CSS .}</p>
              </div>
            </div>
            ...
            <div class="max-w-screen-lg mx-auto">
              <div class="grid grid-cols-2 md:grid-cols-6 gap-x-2">
